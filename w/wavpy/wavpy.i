...
#include "../src/twoDim_planar_array.h"
...
%apply (double IN_ARRAY1[ANY]) {(double BF_phases[16])}
%apply (signed char IN_ARRAY1[ANY]) {(signed char signal_elements_1[16])}
%apply (signed char IN_ARRAY1[ANY]) {(signed char signal_elements_2[16])}
%apply (signed char IN_ARRAY1[ANY]) {(signed char signal_elements[16])}
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* Icomp_out, int len_I)}
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* Qcomp_out, int len_Q)}
...
%clear (double BF_phases[16]);
%clear (signed char signal_elements_1[16]);
%clear (signed char signal_elements_2[16]);
%clear (signed char signal_elements[16]);
%clear (double* Icomp_out, int len_I);
%clear (double* Qcomp_out, int len_Q);
...
%apply (double* IN_ARRAY1, int DIM1) {(double* wav_i_in, int wav_i_in_length)}
%apply (double* IN_ARRAY1, int DIM1) {(double* wav_q_in, int wav_q_in_length)}
...
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* tau_der, int size_tau_der)}
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* wav_der, int size_wav_der)}
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* wav_der1, int size_wav_der1)}
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* wav_der2, int size_wav_der2)}
%include "../src/waveform_power.h"
...
%clear (double* wav_i_in, int wav_i_in_length);
%clear (double* wav_q_in, int wav_q_in_length);
%clear (double* waveform_out, int wav_out_length);
%clear (double* range, int size_range);
%clear (double* tau_der, int size_tau_der);
%clear (double* wav_der, int size_wav_der);
%clear (double* wav_der1, int size_wav_der1);
%clear (double* wav_der2, int size_wav_der2);
...
%apply (double IN_ARRAY1[ANY]) {(double antenna_vector_E_in[3])}
%apply (double IN_ARRAY1[ANY]) {(double antenna_vector_H_in[3])}
%apply (double IN_ARRAY1[ANY]) {(double antenna_vector_k_in[3])}
%apply (double ARGOUT_ARRAY1[ANY]) {(double antenna_vector_E_out[3])}
%apply (double ARGOUT_ARRAY1[ANY]) {(double antenna_vector_H_out[3])}
%apply (double ARGOUT_ARRAY1[ANY]) {(double antenna_vector_k_out[3])}
%apply (double* IN_ARRAY2, int DIM1, int DIM2) {(double* element_pos_in, int num_elem_in, int plane_dim)}
%apply (double* IN_ARRAY1, int DIM1) {(double* phase_delay_in, int num_elems_in)}
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* phase_delay_out, int num_elems_out)}
%apply (double ARGOUT_ARRAY2[ANY][ANY]) {(double array_factor_dB_out[90][360])}
%apply (double IN_ARRAY1[ANY]) {(double inertials[3])}
%apply (double IN_ARRAY1[ANY]) {(double posR_km[3])}
%apply (double IN_ARRAY1[ANY]) {(double posT_km[3])}
%include "../src/twoDim_planar_array.h"
%clear (double antenna_vector_E_in[3]);
%clear (double antenna_vector_H_in[3]);
%clear (double antenna_vector_k_in[3]);
%clear (double antenna_vector_E_out[3]);
%clear (double antenna_vector_H_out[3]);
%clear (double antenna_vector_k_out[3]);
%clear (double* element_pos_in, int num_elem_in, int plane_dim);
%clear (double* phase_delay_in, int num_elems_in);
%clear (double* phase_delay_out, int num_elems_out);
%clear (double array_factor_dB_out[90][360]);
%clear (double inertials[3]);
%clear (double posR_km[3]);
%clear (double posT_km[3]);
...
%apply (double* IN_ARRAY1, int DIM1) {(double* lambda_in, int lambda_length)}
%include "../src/gnss_composite.h"
%clear (double* range_vec, int range_length);
%clear (double* lambda_out, int lambda_length);
%clear (double* lambda_in, int lambda_length);
...
%apply (double ARGOUT_ARRAY1[ANY]) {(double vector_RPY_out[3])}
