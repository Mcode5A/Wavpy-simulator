...
{
  std::cout << "check_Mallorca_ddm" << std::endl;
  if (argc < 2)
  {
  ...
  unsigned int Nsamples = 80000*10;
  unsigned int n0 = 5000;
  int min_m = -15;
  unsigned int step_m = 1;
  int max_m = 15;
  
  std::cout << "Computing DDM..." << std::endl;
  ...
  DDM ddm1(A1, B1, Nsamples, n0, min_m, step_m, max_m, -150, 25, 150);
  //DDM ddm2(A2, B2, Nsamples, n0, min_m, step_m, max_m, -200, 100, 200);
  //DDM ddm3(A1, B2, Nsamples, n0, min_m, step_m, max_m, -200, 100, 200);
