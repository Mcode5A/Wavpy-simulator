...
compute_surface_reflection_Receiver_barrel(Nx/size_procs,Ny, Dx, Dy, deltaX, deltaY, init_point_XX, init_point_YY, LANDA, Amp, Temp, Salinity,  &sat_coor_transmitter, &sat_coor_receiver, &polarization_inc, &polarization_ref, pol_dir_RX, surface, barrel_result_Reduce, azimut, inclination, RX_RADIO);
